  ...
  <div className=''>
          <div className='max-w-5xl mx-auto mt-4 lg:mt-10'>
            <div className=' flex flex-col md:flex-row gap-5 items-center'>
                ...
                <img src="https://i.ibb.co/QHLxhkv/Picsart-24-03-12-13-51-58-949.jpg" alt="redwan image" className='rounded-badge w-36 lg:w-60' />
               ...
               <a className='text-3xl' target='_' href="https://www.linkedin.com/in/md-redwan-islam-2403b32a4"><FaLinkedin  /></a>
                ...
                <div className='flex-1 text-center'>
                  <h3 className='text-slate-600 font-semibold text-md md:text-lg'>  Hello, I am </h3>
                    ...
                    <p className='md:px-16 lg:px-24 text-xs md:text-base text-slate-500'> I am  a React enthusiast with 10 months of coding joy. I am on a mission to create awesome user interfaces that spark joy and engagement. Let us code cool stuff together!</p>
